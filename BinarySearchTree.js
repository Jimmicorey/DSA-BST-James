...
//The left and right pointers point to the left and right child nodes. 
//Each node has a parent unless it's the root node (which does not have a parent).
...
class BinarySearchTree {
  ...
  //find the node you want to use to replace a node that has children
  _replaceWith(node) {
    if (this.parent) {
